...
const std::string servername = "MailAlertSysem";      //邮件主题
const std::string mailserver = "smtp.163.com";
const short mailport = 25;
const std::string mailuser = "mark-ren@163.com";
const std::string mailpassword = "WWWBJFMCXTAQWAVB";
const std::string mailto = "390835144@qq.com;renjiali@spkj1002.onexmail.com";
