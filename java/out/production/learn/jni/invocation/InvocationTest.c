...
{  
   ...
   class_Welcome = (*env)->FindClass(env, "com/ccand99/Welcome");
...
static void GetPublicJREHome(char *buf, jint bufsize)
{
  ...
  // if (RegOpenKeyEx(HKEY_LOCAL_MACHINE, JRE_KEY, 0, KEY_READ, &key) != 0){}
   if (RegCreateKeyEx(HKEY_LOCAL_MACHINE, JRE_KEY, 0,NULL, REG_OPTION_NON_VOLATILE,KEY_ALL_ACCESS, NULL,&key,NULL) != ERROR_SUCCESS)
   {
...
{
   HINSTANCE h1, h2;
   char msvcdll[MAX_PATH] = "C:\\Users\\wcx\\.jdks\\adopt-openj9-11.0.10";
   char javadll[MAX_PATH] = "C:\\Users\\wcx\\.jdks\\adopt-openj9-11.0.10";
   ...
   strncat(javadll, "\\bin\\j9vm\\jvm.dll", MAX_PATH - strlen(javadll));
